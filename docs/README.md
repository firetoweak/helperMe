...
| [CLI 能力](架构/CLI能力.md) | 第四个能力端口：外部 CLI 的登记、安装、体检与调用 |
...
| [Command 授权](架构/Command授权.md) | Command Authorization 契约；Control Approval 另做 |
...
| [工作区与多沙箱隔离](讨论/工作区与多沙箱隔离0918.md) | 2026-09-18 讨论过程；现行边界见《多活跃会话》《Web》《ACP 映射》 |
